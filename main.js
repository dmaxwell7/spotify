...
const clientId = "7b3dab952b4f4a84bdc9dfee8ba3eab8";
const clientSecret = "19976a8f2f864f0f8b9b1c80526c4222";
 ...
 */
  ...
  */
  ...
  function getSong(id,event){
      switch(id){
          case 'fig1': { //rod wave mafia
              event.stopPropagation();
              clickedEvent(0,0)
              break;
          }
          case 'fig2': { // lil baby stand on it
              event.stopPropagation();
              clickedEvent(1,0)
              break;
          }
          case 'fig3': { //sza good time
              event.stopPropagation();
              clickedEvent(2,0)
              break;
          }
          case 'fig4': { //big boogie pop out
              event.stopPropagation();
              clickedEvent(3,0)
              break;
          }
          case 'fig5': { //kodak 300 blackout
              event.stopPropagation();
              clickedEvent(4,0)
              break;
          }
          case 'fig6': { //gucci heavy
              event.stopPropagation();
              clickedEvent(5,0)
              break;
          }
